...
#Error
tellraw @a ["",{"text":"> ","color":"#CCCDFF"},{"text":"ERROR: Unable to install \"","color":"#FF352E"},{"text":"Guns (V1.0)","color":"#713D3D"},{"text":"\" please install dependency \"","color":"#FF352E"},{"text":"Inkwell Core","color":"#9C6D93"},{"text":"\" of at least version ","color":"#FF352E"},{"text":"1.0","color":"#9C6D93"},{"text":".","color":"#FF352E"}]
#Loop notice
